...
window.onload=() => {
    eventListeners();  //tambie se ejecuta cuando carga el html 
   ...
   imprimirCitas() { 
        ...
        objectStore.openCursor().onsuccess= function(e){
            ...
            if(cursor){
                ...
                const cita=cursor.value; // para que cambie cada que edito diferente cita, si no se repite misma cita al editar 
