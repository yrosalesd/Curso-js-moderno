...
function consultarAPI( ciudad, pais){
    ...
    const url=`https://api.openweathermap.org/data/2.5/weather?q=${ciudad},${pais}&appid=${appId}`; // consulta lo que nosostros estamos pidiendo 

    Spinner(); //muestra un spinner de carga // lugar donde comienza a consultar el servidor 
